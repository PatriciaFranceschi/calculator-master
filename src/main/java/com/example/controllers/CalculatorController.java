...
public class CalculatorController {
    ...
    public String getCalculatorPage(Model model){
        model.addAttribute("modelloOperazione",operationModel);
        return "calculator";
    }

    @RequestMapping(value="/calculator", params="add", method = RequestMethod.POST)
    public String add(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String subtract(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String multiply(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String divide(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String fibonacci(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String sqrt(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String power(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String factorial(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String clearSimple(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
    ...
    public String clearAdvanced(@ModelAttribute("modelloOperazione")  OperationModel operationModel, Model model ){
